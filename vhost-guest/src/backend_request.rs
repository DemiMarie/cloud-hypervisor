...
use super::queue_pair::{FdRearm, Translate, VirtioVhostGuestQueuePair};
use crate::queue_pair::Fds;
use crate::{Direction, extract_fd};

pub struct BackendRequestQueuePair {
    queue_pair: VirtioVhostGuestQueuePair,
}
...
impl BackendRequestQueuePair {
    ...
    pub fn new(queue_pair: VirtioVhostGuestQueuePair) -> Self {
        Self { queue_pair }
    }
