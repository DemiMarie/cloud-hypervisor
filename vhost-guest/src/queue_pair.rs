...
pub(super) struct VhostUserMsgHeader {
    pub request: u32,
    pub flags: u32,
    pub size: u32,
}
...
pub struct VirtioVhostGuestQueuePair {
...
impl VirtioVhostGuestQueuePair {
    pub fn new(
        (front2back_queue, front2back_queue_evt): (Queue, EventFd),
        (back2front_queue, back2front_queue_evt): (Queue, EventFd),
        socket: Option<UnixStream>,
        mem: GuestMemoryAtomic<GuestMemoryMmap<AtomicBitmap>>,
    ) -> Self {
        Self {
