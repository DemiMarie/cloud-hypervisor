...
pub fn fstat(fd: BorrowedFd) -> io::Result<libc::stat64> {
    // SAFETY: callback will call libc function with correct arguments,
    // and if it returns 0 kernel initialized struct.
...
impl EventfdChecker {
    ...
    #[allow(clippy::useless_conversion)]
    pub fn from_proc_root(root: ProcRoot) -> io::Result<Self> {
    ...
    pub fn check_is_eventfd(&self, fd: BorrowedFd) -> io::Result<bool> {
